...
export function get_current_demand(): elements {
    ...
    return new_elements(
        (state.current_diet_target.elements.proteins*p)-elements_consumed_today.proteins+state.leftovers.proteins, 
        (state.current_diet_target.elements.fats*p)-elements_consumed_today.fats+state.leftovers.fats, 
        (state.current_diet_target.elements.carbohydrates*p)-elements_consumed_today.carbohydrates+state.leftovers.carbohydrates)
}